    ...
    <div className="text-center mb-12">
      <div className="flex items-center justify-center mb-6">
        <div className="relative">
          <MessageCircle className="h-16 w-16 text-blue-600 dark:text-blue-400 cb:text-cbBlue" />
          <div className="absolute -top-2 -right-2 w-6 h-6 bg-green-500 cb:bg-cbBluishGreen rounded-full flex items-center justify-center">
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
        <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          <Phone className="h-8 w-8 text-blue-600 dark:text-blue-400 cb:text-cbBlue mx-auto mb-3" />
        ...
        <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          <Mail className="h-8 w-8 text-green-600 dark:text-green-400 cb:text-cbBluishGreen cb:dark:text-cbBluishGreen mx-auto mb-3" />
          ...
          <div className="space-y-1">
            <div className="text-lg font-bold text-green-600 dark:text-green-400 cb:text-cbBluishGreen cb:dark:text-cbBluishGreen">help@ukwatertracker.gov.uk</div>
            <div className="text-sm text-gray-500 dark:text-gray-400">General inquiries</div>
          </div>
        </div>

        <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          <Clock className="h-8 w-8 text-purple-600 dark:text-purple-400 cb:text-cbPurple cb:dark:text-cbPurple mx-auto mb-3" />
          ...
          <div className="space-y-1">
            <Badge className="bg-green-600 cb:bg-cbBluishGreen text-white">Online Now</Badge>
      ...
      <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg max-w-2xl mx-auto">
        <div className="flex items-center justify-center space-x-3">
          <Shield className="h-5 w-5 text-blue-600 dark:text-blue-400 cb:text-cbBlue" />
          <span className="text-blue-800 dark:text-blue-200 cb:text-cbBlue cb:dark:text-cbBlue font-medium">
