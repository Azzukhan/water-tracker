...
export function BlogsHeader() {
  return (
    <div className="text-center mb-12">
      ...
      {/* Mission Statement */}
      <div className="mt-8 p-6 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg max-w-4xl mx-auto">
        <div className="flex items-start space-x-3">
          <Award className="h-6 w-6 text-green-600 dark:text-green-400 mt-1" />
          <div>
            <h3 className="font-semibold text-green-900 dark:text-green-100 mb-2">Our Mission</h3>
