...
const getUVIndexColor = (index: number) => {
  if (index <= 2) return "bg-green-600 cb:bg-cbBluishGreen"
  if (index <= 5) return "bg-yellow-600 cb:bg-cbYellow"
  if (index <= 7) return "bg-orange-600 cb:bg-cbOrange"
  if (index <= 10) return "bg-red-600 cb:bg-cbVermillion"
  return "bg-purple-600 cb:bg-cbPurple"
}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center space-x-2">
              <svg className="h-5 w-5 text-blue-500 dark:text-blue-400 cb:text-cbBlue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
