  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const res = await fetch(`${API_BASE}/api/water-levels/groundwater-predictions/?region=${region}&model_type=LSTM`);
        ...
        <div className="mb-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-purple-800">Forecast generated using an LSTM model.</p>
            </div>
          </div>
        </div>
