            ...
            <LineChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                  ...
                  if (active && payload && payload.length) {
                    ...
                    return (
                      <div className="bg-white dark:bg-gray-800 p-4 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg">
                        ...
                        {d.predicted && (
                          <>
                            <p style={{ color: isColorBlind ? "#D55E00" : "#a855f7" }}>
              ...
              {showUncertainty && (
                <Area
                  ...
                  dataKey="upperBound"
                  stroke="none"
                  fill={isColorBlind ? "#D55E00" : "#a855f7"}
                  fillOpacity={0.1}
                />
              )}
              {showUncertainty && (
              ...
              <Line
                type="monotone"
                dataKey="predicted"
                stroke={isColorBlind ? "#D55E00" : "#a855f7"}
                strokeWidth={3}
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-6">
          <div className="p-4 bg-purple-50 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              ...
              <TrendingUp
                className="h-4 w-4"
                style={{ color: isColorBlind ? "#D55E00" : "#a855f7" }}
              />
            </div>
            <div
        ...
        <div className="flex flex-wrap items-center justify-center space-x-6 text-sm mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
          ...
          <div className="flex items-center space-x-2">
            <div
              ...
              style={{ borderColor: isColorBlind ? "#D55E00" : "#a855f7" }}
            ></div>
