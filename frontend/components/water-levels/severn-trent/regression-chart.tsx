...
export function SevernTrentRegressionChart() {
    ...
    const fetchData = async () => {
      try {
        const [histRes, forecastRes, accRes] = await Promise.all([
          ...
          fetch(`${API_BASE}/api/water-levels/severn-trent/REGRESSION`),
          fetch(
    ...
    <Card className="shadow-lg border-0">
      <CardHeader>
        <div className="flex items-center justify-between space-y-4 sm:space-y-0">
          <CardTitle className="text-xl font-bold">Severn Trent Forecast - Regression</CardTitle>
            ...
            <LineChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                  ...
                  if (active && payload && payload.length) {
                    ...
                    return (
                      <div className="bg-white dark:bg-gray-800 p-4 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg">
                        ...
                        {d.predicted && (
                          <>
                            <p style={{ color: isColorBlind ? "#CC79A7" : "#a855f7" }}>
              ...
              {showUncertainty && (
                <Area
                  ...
                  dataKey="upperBound"
                  stroke="none"
                  fill={isColorBlind ? "#CC79A7" : "#a855f7"}
                  fillOpacity={0.1}
                />
              )}
              {showUncertainty && (
              ...
              <Line
                type="monotone"
                dataKey="predicted"
                stroke={isColorBlind ? "#CC79A7" : "#a855f7"}
                strokeWidth={3}
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-6">
          <div className="p-4 bg-purple-50 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              ...
              <TrendingUp
                className="h-4 w-4"
                style={{ color: isColorBlind ? "#CC79A7" : "#a855f7" }}
              />
            </div>
            <div
        ...
        <div className="flex flex-wrap items-center justify-center space-x-6 text-sm mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
          ...
          <div className="flex items-center space-x-2">
            <div
              ...
              style={{ borderColor: isColorBlind ? "#CC79A7" : "#a855f7" }}
            ></div>
