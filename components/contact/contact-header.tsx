    ...
    <div className="text-center mb-12">
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
        <div className="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <p className="text-sm text-gray-600 mb-3">24/7 emergency and general inquiries</p>
          <div className="space-y-1">
            <div className="text-lg font-bold text-blue-600">0800 123 4567</div>
            <div className="text-sm text-gray-500">Free from UK landlines</div>
          </div>
        </div>
        ...
        <div className="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="space-y-1">
            <div className="text-lg font-bold text-green-600">help@ukwatertracker.gov.uk</div>
        ...
        <div className="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <p className="text-sm text-gray-600 mb-3">Instant support during business hours</p>
          <div className="space-y-1">
