...
import { Cloud, CloudRain, Sun, Wind, Droplets, Eye, Thermometer, MapPin, LocateFixed, RefreshCw, Sunrise, Sunset, Moon, CloudLightning } from "lucide-react"
  ...
  async function fetchWeather(loc: Location, retry = 0) {
    ...
    try {
      ...
      const transformed: WeatherData = {
        ...
        sun: {
          sunrise: data.daily?.[0]?.sunrise_time,
          sunset: data.daily?.[0]?.sunset_time
        },
        moon: {
          phase: data.daily?.[0]?.moon_phase
        },
        aqi: {
          value: data.current.aqi,
          category: data.current.aqi_category
        }
      };
      ...
      <main className="pt-20">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">UK Weather Report</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive weather data, forecasts, and environmental conditions across the United Kingdom
            </p>
          </div>
          {/* Location Input */}
          <div className="mb-8 relative">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                {/* Dropdown */}
                {showDropdown && (
                  <div ref={dropdownRef} className="absolute z-20 w-full mt-1 bg-white rounded-md shadow-lg max-h-60 overflow-y-auto border border-gray-200">
            ...
            <div className="mt-2 text-sm text-gray-600">
              <span className="font-medium">Current location:</span> {location ? location.name : "-"}
            </div>
          </div>
          {/* Current Conditions */}
          <div className="mb-12">
